        ...
        <div className="flex flex-col gap-[6vh] w-[28.6vh] items-center">
          <div className="flex flex-col items-center gap-[0.5vh]">
            <div className="relative w-[6vh] h-[10vh]">
              <img src={logo_main.src} alt="SC ATM" className="w-full h-full" style={{ filter: 'brightness(0) invert(1)' }} />
            </div>
            <div className="relative w-[10vh] h-[2vh]">
              <img src={logo_title.src} alt="NhoNho Logo" className="w-full h-full" style={{ filter: 'brightness(0) invert(1)' }} />
            </div>
            <div className="relative w-[15vh] h-[1vh]">
              <img src={logo_slogan.src} alt="" className="w-full h-full" style={{ filter: 'brightness(0) invert(1)' }} />
            </div>
          </div>
